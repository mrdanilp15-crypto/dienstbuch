...
def get_report_styles():
    ...
    /* Session-Page ohne feste Mindesthöhe, um unnötige Leerseiten zu vermeiden */
    ...
    /* Kameraden-Unterschriften deutlich größer (45px statt 28px) */
    ...
    /* Unterschriften Bereich - Folgt jetzt natürlich auf die Tabelle */
...
def generate_single_report(s, persons):
    ...
    <div class="session-page">
        ...
        <div class="topic-box {cat_class}">
            <span style="font-size:10px; font-weight:bold; text-transform:uppercase; opacity:0.8;">{cat}</span>
            <div style="font-size:16px; font-weight:bold;">{s['description']}</div>
        </div>
        <table>
    ...
    html += f"""
        ...
        <div class="sig-container">
            <div class="sig-block">Buxheim, den {sign_date}<div class="sig-line-text">Ort / Datum</div></div>
            <div class="sig-block">{l_sig_html}<div class="sig-line-text">Unterschrift Leitung</div></div>
        </div>
    </div>"""
    return html

def generate_year_report(gname, year, p_stats, cat_sums):
    ...
    <div class="session-page">
        ...
        <h3 style="border-bottom:1px solid #ddd; padding-bottom:5px;">Personal-Übersicht</h3>
        <table>
    ...
    html += f"""
        ...
        <div class="sig-container">
            <div class="sig-block">Buxheim, den {today}<div class="sig-line-text">Ort / Datum</div></div>
