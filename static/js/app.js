    ...
    createApp({
        data() {
            return {
                ...
                users: [],
                vehicleLogs: [],
                registry: { station_name: 'Feuerwehr Dienstbuch' },
                tickets: [],
                archiveDocs: [],
                activeAlarm: {},
                activeEriCard: null,
        ...
        computed: {
            ...
            statistics() {
                ...
                return { 
                    ...
                    uebungen, einsatze, sonstiges,
                    members: safePersonnel.length,
                    agtCount, maschinistCount, gfCount,
                    mtaBasis, mtaErgaenzung, mtaFertig
                };
            }
        },
        methods: {
